...
export function Header() {
  ...
  const headerClass = id.includes("blog") ? "bg-gray-500" : "bg-gray-600";
    ...
    <header className={`${headerClass}  py-6`}>
      <div className="flex items-center justify-between px-11">
        ...
        <div className="space-x-7 ">
          <Link to="/" className="text-xl text-white underline">
            {" "}
            Home
          </Link>

          <Link to="/blog" className="text-xl text-white underline">
            Blog
          </Link>
        </div>
      </div>
